...
test('checkout page loads @environment', async ({ page }) => {
  await page.goto('http://127.0.0.1:65531/checkout');
  await new Label(page, 'heading', 'checkout heading').expectVisible();
});
